...
class Products with ChangeNotifier {
  ...
  Future<void> fetchData() async {
    final url = "https://flutter-app-5f6e0-default-rtdb.firebaseio.com/product.json?auth=$authToken";
    try {
  ...
  Future<void> updateData(String id) async {
    final url = "https://flutter-app-5f6e0-default-rtdb.firebaseio.com/product/$id.json?auth=$authToken";
